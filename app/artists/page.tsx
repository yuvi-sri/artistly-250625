...
export default function ArtistsPage() {
  ...
  ...artist,
  id: String(artist.id || artist.name || index), // ensure unique string ID
  category: Array.isArray(artist.category) ? artist.category : [artist.category], // normalize to array
}));
